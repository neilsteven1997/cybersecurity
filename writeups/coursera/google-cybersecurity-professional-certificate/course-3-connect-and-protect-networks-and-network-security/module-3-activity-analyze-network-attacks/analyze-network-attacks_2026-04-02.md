...
**Goal:** _Analyze HTTP Logs captured by a network protocol analyzer to investigate potential malicious activity. Provide the name of the network intrusion attack, and a description of how the attack negatively impacts network performance.
_
